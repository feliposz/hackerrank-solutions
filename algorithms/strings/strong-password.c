...
int minimumNumber(int n, char* password) {
    ...
    for (int i = 0; i < n; i++) {
        ...
        if (c >= '0' && c <= '9') {
            ...
            for (int j = 0; special_characters[j]; j++) {
    ...
    int missing_types = 4 - has_digit - has_upper - has_lower - has_special;
    int missing_len = 6 - n;
    
    int missing = missing_len > missing_types ? missing_len : missing_types;
